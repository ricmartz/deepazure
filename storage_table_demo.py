...
# added commented lines by Ricardo M.
...
resourcegroup_name = 'ricm'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'ricm'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'westus'
...
car.price = 25500
table_service.insert_entity('itemstable', car)
print('Created entry for Mazda MX9...')
...
car.price = 32500
table_service.insert_entity('itemstable', car)
print('Created entry for Lexus LS400...\n')
